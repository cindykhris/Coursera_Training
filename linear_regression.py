...
Authors: Cindy Pino
Date: 4/7/2020
Tittle: Off-Platfor Project: Reggie's Linear Regression
Description: Project: Linear Regression
...
possible_ballsize = [x *.5 for x in range(-10,20)]

y_bounce = 0
for x in possible_ballsize:
    y_bounce = get_y(0.3,1.7,x)
